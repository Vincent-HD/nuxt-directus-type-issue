...
export type Article = {
  ...
  replaced_by?: string | Article | null;
  status_id: number;
  stock: number;
...
export type Vehicle = {
  ...
  brand: string;
  capacity_cylinder_ccm?: number | null;
  capacity_cylinder_liter?: number | null;
  construction_type: string;
  cylinder_count?: number | null;
  displacement?: number | null;
  engine_type: string;
  fuel_process_type?: string | null;
